...
import 'package:monte/core/domain/ai/famous_amateurs.dart';
...
final List<PlayerProfile> homeGameProfiles = [
  ...
  // Well-known recreationals who are not in the owner's home game.
  ...famousAmateurs,
];

/// Seth Moeller — poker blogger; a top-tier (10/10) recreational who knows the
/// game inside-out. Solid, positionally aware and hard to run over, but leans
/// exploitative rather than pure GTO: he picks spots, applies pressure and pays
/// off less than a solver would. Modelled as an amateur (persistent personality)
/// at the ceiling of the strength scale.
final PlayerProfile sethMoeller = buildAmateur(
  id: 'H100',
  name: 'Seth Moeller',
  strength: 10, // near-pro execution
  vpip: 0.26,
  pfr: 0.20, // raises rather than limps — a real TAG base
  threeBet: 0.08,
  exploitativeWeight: 0.55, // reads and pressure over solver balance
  riskPremium: 1.1,
  tiltResistance: 0.85,
  archetype: 'Exploitative_Blogger',
);
...
/// Experienced, balanced; low bluff, straightforward ABC poker.
final PlayerProfile rodneyJackson = buildAmateur(
  id: 'H028',
  name: 'Rodney Jackson',
  strength: 6,
  vpip: 0.30,

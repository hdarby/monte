...
import 'package:monte/features/coach/domain/coach_report.dart';

/// Re-exported so existing `import '.../hand_coach.dart'` call sites keep
/// resolving the report types after they moved to their own file.
export 'package:monte/features/coach/domain/coach_report.dart';
